...
import PlaygroundVerifyTab from "./PlaygroundVerifyTab";
      ...
      <div className="glass-panel p-6 rounded-2xl">
        ...
        {subTab === "search" && (
          <PlaygroundSearchTab
            ...
            searchProjectRoot={searchProjectRoot}
            setSearchProjectRoot={setSearchProjectRoot}
        ...
        {subTab === "verify" && (
          <PlaygroundVerifyTab
            verifyFilePath={verifyFilePath}
            setVerifyFilePath={setVerifyFilePath}
            verifyProjectRoot={verifyProjectRoot}
            setVerifyProjectRoot={setVerifyProjectRoot}
            verifyCode={verifyCode}
            setVerifyCode={setVerifyCode}
            runCodeVerification={runCodeVerification}
            verifying={verifying}
